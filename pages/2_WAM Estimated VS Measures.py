...
if fit_file is not None:
    ...
    comp_fig.add_trace(
        go.Scatter(name="Climbing", x=filtered_df['seconds'], y=filtered_df['climbing_force'].rolling(roll).mean()))
    comp_fig.add_trace(
        go.Scatter(name="Rolling", x=filtered_df['seconds'], y=filtered_df['rolling_force'].rolling(roll).mean()))
    comp_fig.add_trace(
        go.Scatter(name="Acceleration", x=filtered_df['seconds'], y=filtered_df['speed_change'].rolling(roll).mean()))
    pvam_fig.update_layout(
